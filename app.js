...
const charMeta = {
  ...
  luke:        { en:"LUKE",     color:"#2a7de1", imgStyle:"left:31%;top:-95%;height:590%;width:auto;display:block" },
  jamie:       { en:"JAMIE",    color:"#3fae49", imgStyle:"left:31%;top:-75%;height:570%;width:auto;display:block" },
  chunli:      { en:"CHUN-LI",  color:"#2f6fd6", imgStyle:"left:34%;top:-105%;height:590%;width:auto;display:block" },
  kimberly:    { en:"KIMBERLY", color:"#a03cc8", imgStyle:"left:32%;top:-183%;height:490%;width:auto;display:block" },
  juri:        { en:"JURI",     color:"#9b30ce", imgStyle:"left:25%;top:-228%;height:500%;width:auto;display:block" },
  ken:         { en:"KEN",      color:"#d42a1c", imgStyle:"left:19%;top:-91%;height:560%;width:auto;display:block" },
  blanka:      { en:"BLANKA",   color:"#3f9e28", imgStyle:"left:27%;top:-144%;height:500%;width:auto;display:block" },
  dhalsim:     { en:"DHALSIM",  color:"#d47f1e", imgStyle:"left:25%;top:-56%;height:540%;width:auto;display:block" },
  ehonda:      { en:"E.HONDA",  color:"#3a5fc0", imgStyle:"left:21%;top:-235%;height:670%;width:auto;display:block" },
  deejay:      { en:"DEE JAY",  color:"#e8a020", imgStyle:"left:13%;top:-63%;height:500%;width:auto;display:block" },
  manon:       { en:"MANON",    color:"#4a5fc4", imgStyle:"left:12%;top:-99%;height:580%;width:auto;display:block" },
  marisa:      { en:"MARISA",   color:"#c9a02a", imgStyle:"left:31%;top:-125%;height:500%;width:auto;display:block" },
  lily:        { en:"LILY",     color:"#2ab5a5", imgStyle:"left:22%;top:-201%;height:620%;width:auto;display:block" },
  cammy:       { en:"CAMMY",    color:"#4caf50", imgStyle:"left:24%;top:-21%;height:580%;width:auto;display:block" },
  rashid:      { en:"RASHID",   color:"#2e9e5b", imgStyle:"left:23%;top:-184%;height:620%;width:auto;display:block" },
  aki:         { en:"A.K.I.",   color:"#8a3ad4", imgStyle:"left:17%;top:-162%;height:540%;width:auto;display:block" },
  gouki_akuma: { en:"AKUMA",    color:"#8e1c1c", imgStyle:"left:27%;top:-114%;height:550%;width:auto;display:block" },
  vega_mbison: { en:"M.BISON",  color:"#c02040", imgStyle:"left:30%;top:-81%;height:610%;width:auto;display:block" },
  mai:         { en:"MAI",      color:"#e04a3a", imgStyle:"left:22%;top:-177%;height:600%;width:auto;display:block" },
  elena:       { en:"ELENA",    color:"#48b8d8", imgStyle:"left:13%;top:-400%;height:670%;width:auto;display:block" },
  sagat:       { en:"SAGAT",    color:"#e0872a", imgStyle:"left:25%;top:-83%;height:640%;width:auto;display:block" },
  alex:        { en:"ALEX",     color:"#6a9e3f", imgStyle:"left:26%;top:-176%;height:600%;width:auto;display:block" },
};
