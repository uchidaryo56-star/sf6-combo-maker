    ...
    <table style="border-collapse:collapse;white-space:nowrap">
      <tbody>
        <tr>
          ...
          <td style="padding:5px 0;vertical-align:middle"><div style="display:flex;gap:1px"><div style="width:22px;height:24px;background:var(--bad);opacity:.8;border-radius:3px"></div><div style="width:22px;height:24px;background:var(--bad);opacity:.8;border-radius:3px"></div><div style="width:22px;height:24px;background:var(--bad);opacity:.8;border-radius:3px"></div><div style="width:22px;height:24px;background:var(--bad);opacity:.8;border-radius:3px"></div><div style="width:22px;height:24px;background:var(--bad);opacity:.8;border-radius:3px"></div><div style="width:22px;height:24px;background:var(--bad);opacity:.8;border-radius:3px"></div><div style="width:22px;height:24px;background:var(--bad);opacity:.8;border-radius:3px"></div><div style="width:22px;height:24px;background:var(--bad);opacity:.8;border-radius:3px"></div><div style="width:22px;height:24px;background:var(--bad);opacity:.8;border-radius:3px"></div><div style="width:22px;height:24px;background:var(--bad);opacity:.8;border-radius:3px"></div></div></td>
          <td style="padding:5px 3px;vertical-align:middle"><div style="width:3px;height:28px;background:var(--accent2);border-radius:2px"></div></td>
          <td style="padding:5px 0;vertical-align:middle;min-width:91px"></td>
        ...
        <tr>
          ...
          <td style="padding:5px 0;vertical-align:middle"><div style="display:flex;gap:1px"><div style="width:22px;height:24px;background:var(--good);opacity:.9;border-radius:3px"></div><div style="width:22px;height:24px;background:var(--good);opacity:.9;border-radius:3px"></div><div style="width:22px;height:24px;background:var(--good);opacity:.9;border-radius:3px"></div><div style="width:22px;height:24px;background:var(--good);opacity:.9;border-radius:3px"></div><div style="width:22px;height:24px;background:var(--good);opacity:.9;border-radius:3px"></div><div style="width:22px;height:24px;background:var(--good);opacity:.9;border-radius:3px"></div><div style="width:22px;height:24px;background:var(--good);opacity:.9;border-radius:3px"></div><div style="width:22px;height:24px;background:var(--good);opacity:.9;border-radius:3px"></div><div style="width:22px;height:24px;background:var(--good);opacity:.9;border-radius:3px"></div><div style="width:22px;height:24px;background:var(--good);opacity:.9;border-radius:3px"></div></div></td>
          <td style="padding:5px 3px;vertical-align:middle"><div style="width:3px;height:28px;background:var(--accent2);border-radius:2px"></div></td>
          <td style="padding:5px 0;vertical-align:middle;min-width:91px"></td>
        ...
        <tr>
          ...
          <td style="padding:5px 0;vertical-align:middle"><div style="display:flex;gap:1px"><div style="width:22px;height:24px;background:var(--panel2);border:1px solid var(--line);border-radius:3px"></div><div style="width:22px;height:24px;background:var(--panel2);border:1px solid var(--line);border-radius:3px"></div><div style="width:22px;height:24px;background:var(--panel2);border:1px solid var(--line);border-radius:3px"></div><div style="width:22px;height:24px;background:var(--panel2);border:1px solid var(--line);border-radius:3px"></div><div style="width:22px;height:24px;background:var(--panel2);border:1px solid var(--line);border-radius:3px"></div><div style="width:22px;height:24px;background:var(--panel2);border:1px solid var(--line);border-radius:3px"></div><div style="width:22px;height:24px;background:var(--panel2);border:1px solid var(--line);border-radius:3px"></div><div style="width:22px;height:24px;background:var(--panel2);border:1px solid var(--line);border-radius:3px"></div><div style="width:22px;height:24px;background:var(--panel2);border:1px solid var(--line);border-radius:3px"></div><div style="width:22px;height:24px;background:var(--panel2);border:1px solid var(--line);border-radius:3px"></div></div></td>
          <td style="padding:5px 3px;vertical-align:middle"><div style="width:3px;height:28px;background:var(--accent2);border-radius:2px"></div></td>
          <td style="padding:5px 0;vertical-align:middle"><div style="display:flex;gap:1px"><div style="width:22px;height:24px;background:var(--bad);opacity:.55;border-radius:3px"></div><div style="width:22px;height:24px;background:var(--bad);opacity:.55;border-radius:3px"></div><div style="width:22px;height:24px;background:var(--bad);opacity:.55;border-radius:3px"></div><div style="width:22px;height:24px;background:var(--bad);opacity:.55;border-radius:3px"></div></div></td>
