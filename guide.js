...
const SF6_GUIDE = [
  ...
  <div style="overflow-x:auto">
    <table style="border-collapse:collapse">
      <tbody>
        <tr>
          <td style="padding:4px 10px 4px 0;font-size:11px;color:var(--text);white-space:nowrap;vertical-align:middle">相手の硬直</td>
          <td style="padding:3px 1px;vertical-align:middle"><div style="width:20px;height:22px;background:var(--bad);opacity:.8;border-radius:2px"></div></td><td style="padding:3px 1px;vertical-align:middle"><div style="width:20px;height:22px;background:var(--bad);opacity:.8;border-radius:2px"></div></td><td style="padding:3px 1px;vertical-align:middle"><div style="width:20px;height:22px;background:var(--bad);opacity:.8;border-radius:2px"></div></td><td style="padding:3px 1px;vertical-align:middle"><div style="width:20px;height:22px;background:var(--bad);opacity:.8;border-radius:2px"></div></td><td style="padding:3px 1px;vertical-align:middle"><div style="width:20px;height:22px;background:var(--bad);opacity:.8;border-radius:2px"></div></td><td style="padding:3px 1px;vertical-align:middle"><div style="width:20px;height:22px;background:var(--bad);opacity:.8;border-radius:2px"></div></td><td style="padding:3px 1px;vertical-align:middle"><div style="width:20px;height:22px;background:var(--bad);opacity:.8;border-radius:2px"></div></td><td style="padding:3px 1px;vertical-align:middle"><div style="width:20px;height:22px;background:var(--bad);opacity:.8;border-radius:2px"></div></td><td style="padding:3px 1px;vertical-align:middle"><div style="width:20px;height:22px;background:var(--bad);opacity:.8;border-radius:2px"></div></td><td style="padding:3px 1px;vertical-align:middle"><div style="width:20px;height:22px;background:var(--bad);opacity:.8;border-radius:2px"></div></td>
          <td style="padding:3px 6px;vertical-align:middle"><div style="width:3px;height:28px;background:var(--accent2);border-radius:2px"></div></td>
          <td style="padding:3px 1px;vertical-align:middle"><div style="width:20px;height:22px"></div></td><td style="padding:3px 1px;vertical-align:middle"><div style="width:20px;height:22px"></div></td><td style="padding:3px 1px;vertical-align:middle"><div style="width:20px;height:22px"></div></td><td style="padding:3px 1px;vertical-align:middle"><div style="width:20px;height:22px"></div></td>
          <td style="padding:4px 0 4px 10px;font-size:11px;color:var(--muted);white-space:nowrap;vertical-align:middle">← -10F（動けない）</td>
        </tr>
        <tr>
          <td style="padding:4px 10px 4px 0;font-size:11px;color:var(--text);white-space:nowrap;vertical-align:middle">発生10F</td>
          <td style="padding:3px 1px;vertical-align:middle"><div style="width:20px;height:22px;background:var(--good);opacity:.9;border-radius:2px"></div></td><td style="padding:3px 1px;vertical-align:middle"><div style="width:20px;height:22px;background:var(--good);opacity:.9;border-radius:2px"></div></td><td style="padding:3px 1px;vertical-align:middle"><div style="width:20px;height:22px;background:var(--good);opacity:.9;border-radius:2px"></div></td><td style="padding:3px 1px;vertical-align:middle"><div style="width:20px;height:22px;background:var(--good);opacity:.9;border-radius:2px"></div></td><td style="padding:3px 1px;vertical-align:middle"><div style="width:20px;height:22px;background:var(--good);opacity:.9;border-radius:2px"></div></td><td style="padding:3px 1px;vertical-align:middle"><div style="width:20px;height:22px;background:var(--good);opacity:.9;border-radius:2px"></div></td><td style="padding:3px 1px;vertical-align:middle"><div style="width:20px;height:22px;background:var(--good);opacity:.9;border-radius:2px"></div></td><td style="padding:3px 1px;vertical-align:middle"><div style="width:20px;height:22px;background:var(--good);opacity:.9;border-radius:2px"></div></td><td style="padding:3px 1px;vertical-align:middle"><div style="width:20px;height:22px;background:var(--good);opacity:.9;border-radius:2px"></div></td><td style="padding:3px 1px;vertical-align:middle"><div style="width:20px;height:22px;background:var(--good);opacity:.9;border-radius:2px"></div></td>
          <td style="padding:3px 6px;vertical-align:middle"><div style="width:3px;height:28px;background:var(--accent2);border-radius:2px"></div></td>
          <td style="padding:3px 1px;vertical-align:middle"><div style="width:20px;height:22px"></div></td><td style="padding:3px 1px;vertical-align:middle"><div style="width:20px;height:22px"></div></td><td style="padding:3px 1px;vertical-align:middle"><div style="width:20px;height:22px"></div></td><td style="padding:3px 1px;vertical-align:middle"><div style="width:20px;height:22px"></div></td>
          <td style="padding:4px 0 4px 10px;font-size:12px;font-weight:700;color:var(--good);white-space:nowrap;vertical-align:middle">✓ 確定○（収まる）</td>
        </tr>
        <tr>
          <td style="padding:4px 10px 4px 0;font-size:11px;color:var(--text);white-space:nowrap;vertical-align:middle">発生14F</td>
          <td style="padding:3px 1px;vertical-align:middle"><div style="width:20px;height:22px;background:var(--panel2);border:1px solid var(--line);border-radius:2px"></div></td><td style="padding:3px 1px;vertical-align:middle"><div style="width:20px;height:22px;background:var(--panel2);border:1px solid var(--line);border-radius:2px"></div></td><td style="padding:3px 1px;vertical-align:middle"><div style="width:20px;height:22px;background:var(--panel2);border:1px solid var(--line);border-radius:2px"></div></td><td style="padding:3px 1px;vertical-align:middle"><div style="width:20px;height:22px;background:var(--panel2);border:1px solid var(--line);border-radius:2px"></div></td><td style="padding:3px 1px;vertical-align:middle"><div style="width:20px;height:22px;background:var(--panel2);border:1px solid var(--line);border-radius:2px"></div></td><td style="padding:3px 1px;vertical-align:middle"><div style="width:20px;height:22px;background:var(--panel2);border:1px solid var(--line);border-radius:2px"></div></td><td style="padding:3px 1px;vertical-align:middle"><div style="width:20px;height:22px;background:var(--panel2);border:1px solid var(--line);border-radius:2px"></div></td><td style="padding:3px 1px;vertical-align:middle"><div style="width:20px;height:22px;background:var(--panel2);border:1px solid var(--line);border-radius:2px"></div></td><td style="padding:3px 1px;vertical-align:middle"><div style="width:20px;height:22px;background:var(--panel2);border:1px solid var(--line);border-radius:2px"></div></td><td style="padding:3px 1px;vertical-align:middle"><div style="width:20px;height:22px;background:var(--panel2);border:1px solid var(--line);border-radius:2px"></div></td>
          <td style="padding:3px 6px;vertical-align:middle"><div style="width:3px;height:28px;background:var(--accent2);border-radius:2px"></div></td>
          <td style="padding:3px 1px;vertical-align:middle"><div style="width:20px;height:22px;background:var(--bad);opacity:.55;border-radius:2px"></div></td><td style="padding:3px 1px;vertical-align:middle"><div style="width:20px;height:22px;background:var(--bad);opacity:.55;border-radius:2px"></div></td><td style="padding:3px 1px;vertical-align:middle"><div style="width:20px;height:22px;background:var(--bad);opacity:.55;border-radius:2px"></div></td><td style="padding:3px 1px;vertical-align:middle"><div style="width:20px;height:22px;background:var(--bad);opacity:.55;border-radius:2px"></div></td>
          <td style="padding:4px 0 4px 10px;font-size:12px;font-weight:700;color:var(--bad);white-space:nowrap;vertical-align:middle">✗ 確定×（はみ出る）</td>
        </tr>
      </tbody>
    </table>
  </div>
